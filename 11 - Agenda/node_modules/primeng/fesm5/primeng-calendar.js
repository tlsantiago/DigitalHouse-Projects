...
var Calendar = /** @class */ (function () {
    ...
    Calendar.prototype.navigateToMonth = function (prev, groupIndex) {
        if (prev) {
            if (this.numberOfMonths === 1 || (groupIndex === 0)) {
                ...
                var cells = DomHandler.find(prevMonthContainer, '.p-datepicker-calendar td a');
            ...
            if (this.numberOfMonths === 1 || (groupIndex === this.numberOfMonths - 1)) {
                ...
                var focusCell = DomHandler.findSingle(nextMonthContainer, '.p-datepicker-calendar td a');
                focusCell.tabIndex = '0';
                focusCell.focus();
            }
        }
    ...
    Calendar.prototype.updateFocus = function () {
        ...
        if (this.navigationState) {
            if (this.navigationState.button) {
                ...
                if (this.navigationState.backward) {
                    var cells = DomHandler.find(this.contentViewChild.nativeElement, '.p-datepicker-calendar td a');
    ...
    Calendar.prototype.initFocusableCell = function () {
        var cell;
        if (this.view === 'month') {
            var cells = DomHandler.find(this.contentViewChild.nativeElement, '.p-monthpicker .p-monthpicker-month:not(.p-disabled)');
            var selectedCell = DomHandler.findSingle(this.contentViewChild.nativeElement, '.p-monthpicker .p-monthpicker-month.p-highlight');
            cells.forEach(function (cell) { return cell.tabIndex = -1; });
            cell = selectedCell || cells[0];
            if (cells.length === 0) {
                var disabledCells = DomHandler.find(this.contentViewChild.nativeElement, '.p-monthpicker .p-monthpicker-month.p-disabled[tabindex = "0"]');
            ...
            if (!cell) {
                var todayCell = DomHandler.findSingle(this.contentViewChild.nativeElement, 'td.p-datepicker-today a:not(.p-disabled)');
                if (todayCell)
                    cell = todayCell;
                else
                    cell = DomHandler.findSingle(this.contentViewChild.nativeElement, '.p-datepicker-calendar td a');
