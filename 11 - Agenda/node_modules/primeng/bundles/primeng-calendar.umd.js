(function (global, factory) {
    ...
    (global = global || self, factory((global.primeng = global.primeng || {}, global.primeng.calendar = {}), global.ng.core, global.ng.animations, global.ng.common, global.primeng.button, global.primeng.ripple, global.primeng.dom, global.primeng.api, global.ng.forms));
    ...
    var Calendar = /** @class */ (function () {
        ...
        Calendar.prototype.navigateToMonth = function (prev, groupIndex) {
            if (prev) {
                if (this.numberOfMonths === 1 || (groupIndex === 0)) {
                    ...
                    var cells = dom.DomHandler.find(prevMonthContainer, '.p-datepicker-calendar td a');
                ...
                if (this.numberOfMonths === 1 || (groupIndex === this.numberOfMonths - 1)) {
                    ...
                    var focusCell = dom.DomHandler.findSingle(nextMonthContainer, '.p-datepicker-calendar td a');
                    focusCell.tabIndex = '0';
                    focusCell.focus();
                }
            }
        ...
        Calendar.prototype.updateFocus = function () {
            ...
            if (this.navigationState) {
                if (this.navigationState.button) {
                    ...
                    if (this.navigationState.backward) {
                        var cells = dom.DomHandler.find(this.contentViewChild.nativeElement, '.p-datepicker-calendar td a');
                        cell = cells[cells.length - 1];
                    }
                    else {
                        cell = dom.DomHandler.findSingle(this.contentViewChild.nativeElement, '.p-datepicker-calendar td a');
                    }
                    if (cell) {
                        cell.tabIndex = '0';
                        cell.focus();
        ...
        Calendar.prototype.initFocusableCell = function () {
            ...
            if (this.view === 'month') {
                ...
                if (!cell) {
                    var todayCell = dom.DomHandler.findSingle(this.contentViewChild.nativeElement, 'td.p-datepicker-today a:not(.p-disabled)');
                    if (todayCell)
                        cell = todayCell;
                    else
                        cell = dom.DomHandler.findSingle(this.contentViewChild.nativeElement, '.p-datepicker-calendar td a');
